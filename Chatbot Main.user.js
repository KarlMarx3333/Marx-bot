...
var Kings = [
    ...
    "ead940199c7d9717e5149919", // hri
	"3fb6d7cd2c8aa3b1d9841a06"// shed ._id
]
...
MPP.client.on('a', msg => {
    ...
    if  (cmd == "/bot_true") {
        if (isKing) {
            if (chatbot == true) {
                MPP.chat.send("The chat bot is already on.");
            } else {
                chatbot = true
                MPP.chat.send("Chat bot is now on.");
            }
        }
    } else if (cmd == "/bot_false") {
        if (isKing) {
            if (chatbot == false) {
                MPP.chat.send("The chat bot is already off");
            } else {
                chatbot = false
                MPP.chat.send("Chat bot is now off.")
            }
        }
        ...
        if (!isBlocked) {
            ...
            if (cmd == "/help") {
                if (isKing) {
                    MPP.chat.send("Commands are listed to fit your rank. Use /rank to learn more. Commands: /help | /test | /about | /rip | /quote | /test | /fact | /loss | /eat | /tickle | /roast | /kill | /stab | /hug | /shoot | /slap | /cuddle | /rape | /friendzone | /fight | /rps | /poke | /ranks | /art | /clearchat | /boom | /kickban | /wave | /bot_true | /bot_false");
                } else if (isNoble) {
                    MPP.chat.send("Commands are listed to fit your rank. Use /rank to learn more. Commands: /help | /test | /about | /rip | /quote | /test | /fact | /loss | /eat | /tickle | /roast | /kill | /stab | /hug | /shoot | /slap | /cuddle | /rape | /friendzone | /fight | /rps | /poke | /ranks | /art | /clearchat | /boom | /kickban | /wave ");
                } else if (isKnight) {
                    MPP.chat.send("Commands are listed to fit your rank. Use /rank to learn more. Commands: /help | /test | /about | /rip | /quote | /test | /fact | /loss | /eat | /tickle | /roast | /kill | /stab | /hug | /shoot | /slap | /cuddle | /rape | /friendzone | /fight | /rps | /poke | /ranks | /art");
                } else {
                    MPP.chat.send("Commands are listed to fit your rank. Use /rank to learn more. Commands: /help | /test | /about | /rip | /quote | /test | /fact | /loss | /eat | /tickle | /roast | /kill | /stab | /hug | /shoot | /slap | /cuddle | /rape | /friendzone | /fight | /rps | /poke | /ranks.");
                }
            } else if (cmd == "/art") {
                if (isKing) {
